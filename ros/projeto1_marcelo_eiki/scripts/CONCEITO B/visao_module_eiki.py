...
def identifica_cor(frame, color):
    ...
    if color=="blue" or color=="azul":
        color_1 = np.array([87, 50, 50])
        color_2 = np.array([ 97, 255, 255])
...
def identifica_cor_amarelo(frame, color):
    '''
    Segmenta o maior objeto cuja cor é parecida com cor_h (HUE da cor, no espaço HSV).
    '''
    ...
    branco_1 = np.array([22, 210, 210])
    branco_2 = np.array([40, 255, 255],)
    ...
    duas_cores =segmentado_cor + cv2.inRange(frame_hsv, color_1, color_2)
